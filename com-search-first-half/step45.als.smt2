...
(assert 
 (! 
  (not (forall ((c Atom)) (=> (in_1 c Component) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (subset_1 (join_1x2 (a2r_1 i) iids) (join_1x2 (join_1x2 (a2r_1 c) interfaces) iids))))))) 
 :named commandd2ffdb45 
 ) 
 )
;; --end command
