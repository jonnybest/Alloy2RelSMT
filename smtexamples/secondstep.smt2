; file: D:\Entwicklung\workspace\alloy2relsmt\smtexamples\secondstep.als 
...
(assert 
 (! 
  (forall ((c Atom)) (=> (in_1 c Component) (and (subset_1 (join_1x2 (a2r_1 c) iids) (join_1x2 (join_1x2 (a2r_1 c) interfaces) iids1)) (subset_1 (join_1x2 (join_1x2 (a2r_1 c) interfaces) iids1) (join_1x2 (a2r_1 c) iids))))) 
 :named assertb429b4e5 
 ) 
 )
(assert 
 (! 
