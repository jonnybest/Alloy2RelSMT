...
(assert 
 (! 
  (not (forall ((c Atom)) (=> (in_1 c LegalComponent) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (= (join_1x2 (a2r_1 i) iidsKnown) (join_1x2 (a2r_1 c) iids))))))) 
 :named c0 
 ) 
 )
;; --end command
...
(forall ((R Rel2)(A Rel1)(B Rel1)) (=> (subset_2 R (prod_1x1 A B)) (forall ((a0 Atom)) (and (=> (and (in_1 a0 A) (no_1 (join_1x2 A R))) (not (in_1 a0 (join_2x1 R B)))) (=> (not (in_1 a0 (join_2x1 R B))) (and (in_1 a0 A) (no_1 (join_1x2 A R)))))))) 
 :named l4 
 ) 
 )
(assert
...
(forall ((R Rel3)(A Rel2)(B Rel1)) (=> (subset_3 R (prod_2x1 A B)) (forall ((a0 Atom)(a1 Atom)) (and (=> (and (in_2 a0 a1 A) (no_3 (join_2x3 A R))) (not (in_2 a0 a1 (join_3x1 R B)))) (=> (not (in_2 a0 a1 (join_3x1 R B))) (and (in_2 a0 a1 A) (no_3 (join_2x3 A R)))))))) 
 :named l9 
 ) 
 )
(assert
