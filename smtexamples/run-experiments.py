...
alloy2relsmtparam = " "#" -jar ..\alloy2relsmt.jar -f "
...
# run alloy2relsmt
            smtfile = file + ".smt2"
            print [alloy2relsmtcmd, alloy2relsmtparam + os.path.abspath(filepath) + " " +join(dirpath, smtfile)]
            output = subprocess.check_output([alloy2relsmtcmd + alloy2relsmtparam ], shell=True)#+ os.path.abspath(filepath) + " " + join(dirpath, smtfile)], shell=True)
