...
(forall ((a1 Atom)(a3 Atom)(R Rel2)) (=> (in_2 a1 a3 (transClos R)) (or (in_2 a1 a3 R) (exists ((a2 Atom)) (and (in_2 a2 a3 R) (in_2 a1 a2 (transClos R))))))) 
 :named lemma6816308a 
 ) 
 )
(assert
...
(assert
 (! 
  ; strong lemma 2 for transClos about the second 'middle element'
