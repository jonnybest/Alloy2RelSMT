...
(assert 
 (! 
  (exists ((c Atom)) (and (in_1 c LegalComponent) (exists ((i Atom)) (and 
    ...
    (not (subset_1 (join_1x2 (join_1x2 (a2r_1 c) interfaces) iids) (join_1x2 (a2r_1 i) iidsKnown)))
  )))) 
 :named a30 
 ) 
 )
(assert 
 (! 
  (forall ((c Atom)) (=> (in_1 c LegalComponent) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (subset_1 (join_1x2 (a2r_1 i) iids) (join_1x2 (a2r_1 i) iidsKnown)))))) 
 :named a31 
 ) 
 )
;; --end assertions
...
(assert 
 (! 
  (not (and (exists ((i Atom)) (and (in_1 i LegalInterface) (not (subset_1 (join_1x2 (a2r_1 i) iids) (join_1x2 (a2r_1 i) iidsKnown))))) (forall ((c Atom)) (=> (in_1 c LegalComponent) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (subset_1 (join_1x2 (a2r_1 c) iids1) (join_1x2 (a2r_1 i) iidsKnown)))))))) 
 :named c0 
 ) 
 )
;; --end command
