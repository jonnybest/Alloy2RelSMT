...
(assert 
 (! 
  (not (and (forall ((c Atom)) (=> (in_1 c LegalComponent) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (subset_1 (join_1x2 (a2r_1 c) iids1) (join_1x2 (a2r_1 i) iidsKnown)))))) (forall ((c Atom)) (=> (in_1 c LegalComponent) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (subset_1 (join_1x2 (a2r_1 i) iidsKnown) (join_1x2 (a2r_1 c) iids1)))))))) 
 :named c0 
 ) 
 )
;; --end command
...
(assert
 (! 
  ; lemma about subsets within joins, from com-theorem1, related to step 55
(forall ((a Rel1)(A Rel1)(b Rel1)(B Rel1)(C Rel1)(R Rel2)(S Rel2)) (=> (and 
    (subset_1 a A)
    (subset_1 b B)
