...
assert Theorem1 {
	...
	/* original check 
	// all c: LegalComponent | all i: c.interfaces | c.iids in i.iidsKnown		// not provable by machine
	// all c: LegalComponent | all i: c.interfaces | i.iidsKnown in c.iids		// proven by machine
	*/
}
