...
(assert 
 (! 
  (forall ((i Atom)) (=> (in_1 i Interface) (= (join_1x2 (a2r_1 i) iidsKnown) (join_2x1 (join_1x3 (a2r_1 i) qi) Interface)))) 
 :named a14 
 ) 
 )
(assert 
...
(assert 
 (! 
  (exists ((c Atom)) (and (in_1 c LegalComponent) (exists ((i Atom)) (and 
    ...
    (not (subset_1 (join_1x2 (a2r_1 c) iids1) (join_1x2 (a2r_1 i) iidsKnown)))
  )))) 
 :named a18 
 ) 
 )
...
(assert 
 (! 
  (not (not (forall ((c Atom)) (=> (in_1 c LegalComponent) (forall ((i Atom)) (=> (and (in_1 i Interface) (in_1 i (join_1x2 (a2r_1 c) interfaces))) (subset_1 (join_1x2 (a2r_1 c) iids1) (join_1x2 (a2r_1 i) iidsKnown)))))))) 
 :named c0 
 ) 
 )
;; --end command
