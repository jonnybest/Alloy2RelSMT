...
(assert 
 (! 
  (exists ((i Atom)) (and (in_1 i LegalInterface) (and (not (subset_1 (join_1x2 (a2r_1 i) iids1) (join_1x2 (a2r_1 i) iidsKnown))) (forall ((i1 Atom)) (=> (in_1 i1 LegalInterface) (subset_1 (join_1x2 (a2r_1 i1) iids1) (join_1x2 (a2r_1 i1) iidsKnown)))))))
 :named c0 
 ) 
 )
; --end command
