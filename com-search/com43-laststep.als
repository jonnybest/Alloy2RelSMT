...
-- full proof outline: ((((A2 and ComponentProps) <=> step42) and lemma45) => step43) <=> step44 ? Reflexivity
...
-- aus 43 ergibt sich, wegen (c.interfaces in LegalInterface) ganz allgemein (gdw): ((((A2 und ComponentProps) <=> 42) und 45 ) => 43) <=> 44 ? 38
