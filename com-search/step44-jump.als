module exploration/com1_minified_j44
...
fact previousStep {
	...
	// this benchmark should show the following 'jump' from A2 => 44
   some i: LegalInterface | i.iids not in i.iidsKnown //44 	
}

assert jump44 {
	some c: LegalComponent | some i: c.interfaces | c.iids not in i.iidsKnown
}
check jump44
