...
assert step42 {
	//not IID = IID // false
	//some c: LegalComponent | some i: c.interfaces | c.interfaces.iids not in i.iidsKnown // step 42 - unknown
	//causes "none": 
	some c: LegalComponent | some i: c.interfaces.iids | i.iids not in i.iidsKnown // step 43 - not finished (and also wrong)
