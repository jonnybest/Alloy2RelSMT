; file: D:\Entwicklung\workspace\alloy2relsmt\com-combination-tests\step42-minified-step44.als 
; hash: 774FD257DF593981684FDA6A6CDEFCBF
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (not (exists ((i Atom)) (and (in_1 i LegalInterface) (not (subset_1 (join_1x2 (a2r_1 i) iids) (join_1x2 (a2r_1 i) iidsKnown))))))) 
 :named command7cc2f22a 
 ) 
 )
;; --end command
