; file: D:\Entwicklung\workspace\alloy2relsmt\com-combination-tests\step1-minified-step44.als 
; hash: A824486363273C58A17923B0F92646B0
(set-logic AUFLIA)
...
(assert 
 (! 
  (not (exists ((c Atom)) (and (in_1 c LegalComponent) (exists ((i Atom)) (and 
    ...
    (not (= (join_1x2 (a2r_1 i) iidsKnown) (join_1x2 (a2r_1 c) iids1)))
  ))))) 
 :named assertce95f4da 
 ) 
 )
(assert 
 (! 
